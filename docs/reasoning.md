...
The x64rag SDK has five capabilities, each one independent:
...
Any x64rag SDK provider satisfies these protocols automatically via structural typing. No inheritance needed — if the signatures match, it works.
...
See also: [Retrieval SDK documentation](retrieval.md) · [SDK reference](../src/x64rag/reasoning/README.md) · [Main README](../README.md)
