...
from x64rag.reasoning.cli.config import build_analysis_service, load_config
from x64rag.reasoning.cli.constants import ConfigError
from x64rag.reasoning.cli.output import OutputMode, print_analysis, print_error, print_json
...
async def _analyze(
    ...
    from x64rag.reasoning.modules.analysis.models import AnalysisConfig, DimensionDefinition
