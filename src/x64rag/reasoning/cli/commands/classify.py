...
from x64rag.reasoning.cli import cli, resolve_input, run_async
from x64rag.reasoning.cli.config import build_classification_service, load_config
from x64rag.reasoning.cli.constants import ConfigError
from x64rag.reasoning.cli.output import OutputMode, print_classification, print_error, print_json
...
async def _classify(toml: dict[str, Any], text: str, categories_file: str, strategy: str, mode: OutputMode) -> None:
    from x64rag.reasoning.modules.classification.models import CategoryDefinition, ClassificationConfig
