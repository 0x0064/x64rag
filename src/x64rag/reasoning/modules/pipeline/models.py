...
if TYPE_CHECKING:
    from x64rag.reasoning.modules.analysis.models import AnalysisConfig, AnalysisResult
    ...
    from x64rag.reasoning.modules.compliance.models import ComplianceConfig, ComplianceResult
    from x64rag.reasoning.modules.compliance.service import ComplianceService
    from x64rag.reasoning.modules.evaluation.models import EvaluationConfig, EvaluationResult
