...
async def test_hyde_rewriter_returns_hypothetical_passage():
    ...
    with (
        ...
        patch("x64rag.retrieval.modules.retrieval.search.rewriting.hyde.build_registry") as mock_registry,
    ):
...
async def test_multi_query_rewriter_returns_variants():
    ...
    with (
        ...
        patch("x64rag.retrieval.modules.retrieval.search.rewriting.multi_query.build_registry") as mock_registry,
    ):
...
async def test_step_back_rewriter_returns_broader_query():
    ...
    with (
        ...
        patch("x64rag.retrieval.modules.retrieval.search.rewriting.step_back.build_registry") as mock_registry,
    ):
