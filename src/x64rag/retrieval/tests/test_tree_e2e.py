...
class TestTreeE2E:
    ...
    def _mock_tree_retrieval_step_resolved(self) -> AsyncMock:
        ...
        from x64rag.retrieval.baml.baml_client.types import ToolResolvedPages
    ...
    async def test_full_pipeline(
        ...
        with (
            ...
            patch(
                "x64rag.retrieval.baml.baml_client.async_client.b.GenerateNodeSummary",
                mock_summary,
            ),
            patch(
                "x64rag.retrieval.baml.baml_client.async_client.b.GenerateDocDescription",
                mock_description,
            ),
        ):
        ...
        with patch(
            "x64rag.retrieval.baml.baml_client.async_client.b.TreeRetrievalStep",
            mock_retrieval_step,
        ):
    ...
    async def test_search_with_drill_down_then_resolve(
        ...
        from x64rag.retrieval.baml.baml_client.types import ToolDrillDown, ToolResolvedPages
        from x64rag.retrieval.modules.ingestion.tree.service import TreeIndexingService
        from x64rag.retrieval.modules.retrieval.tree.service import TreeSearchService
    ...
    async def test_search_with_fetch_then_resolve(
        ...
        from x64rag.retrieval.baml.baml_client.types import ToolFetchPages, ToolResolvedPages
        from x64rag.retrieval.modules.ingestion.tree.service import TreeIndexingService
        from x64rag.retrieval.modules.retrieval.tree.service import TreeSearchService
