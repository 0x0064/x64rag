"""Tests for tree service wiring in RagServer."""

from x64rag.retrieval.server import RagServerConfig, TreeIndexingConfig, TreeSearchConfig
...
class TestRagServerConfigIncludesTree:
    def test_config_has_tree_indexing_field(self) -> None:
        ...
        from x64rag.retrieval.server import IngestionConfig, PersistenceConfig
