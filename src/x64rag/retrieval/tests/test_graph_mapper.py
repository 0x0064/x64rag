...
def test_infer_entity_type_electrical():
    from x64rag.retrieval.stores.graph.mapper import _infer_entity_type
...
def test_cross_refs_to_graph_relations():
    from x64rag.retrieval.stores.graph.mapper import cross_refs_to_graph_relations
...
def test_classify_relationship_keywords():
    from x64rag.retrieval.stores.graph.mapper import _classify_relationship
