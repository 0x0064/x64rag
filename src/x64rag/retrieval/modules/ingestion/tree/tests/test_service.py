...
class TestIndexWithToc:
    ...
    async def test_index_with_toc(self):
        ...
        with (
            ...
            patch(
                "x64rag.retrieval.modules.ingestion.tree.service.TreeIndexingService._generate_summaries",
                new_callable=AsyncMock,
            ) as mock_summaries,
            patch(
                "x64rag.retrieval.modules.ingestion.tree.service.TreeIndexingService._generate_doc_description",
                new_callable=AsyncMock,
...
class TestIndexWithTocWithoutPageNumbers:
    ...
    async def test_index_with_toc_without_page_numbers(self):
        ...
        with (
            ...
            patch(
                "x64rag.retrieval.modules.ingestion.tree.service.find_section_starts",
                new_callable=AsyncMock,
...
class TestIndexNoToc:
    ...
    async def test_index_no_toc(self):
        ...
        with (
            ...
            patch(
                "x64rag.retrieval.modules.ingestion.tree.service.TreeIndexingService._extract_structure_no_toc",
                new_callable=AsyncMock,
...
BAML_CLIENT = "x64rag.retrieval.baml.baml_client.async_client.b"
